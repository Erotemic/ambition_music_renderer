...
# Keep the historical public constant for v1 generator compatibility, but derive
# it from the checked-in technique catalog so v1/v3 and agent documentation use
# one articulation-duration vocabulary. Existing names retain their exact values.
from ..technique_catalog import technique_gate_map

ARTICULATION_GATE = technique_gate_map()
