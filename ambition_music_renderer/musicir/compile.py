...
from .normalize import MUSICIR_V1_SCHEMA, MUSICIR_V2_SCHEMA, MUSICIR_V3_SCHEMA, normalize_musicir_spec
...
def compile_score(
    ...
    *,
    ...
    if normalized.canonical_schema == MUSICIR_V3_SCHEMA:
        from .v3 import compile_v3_score

        compiled = compile_v3_score(
            normalized.spec,
            source_schema=normalized.source_schema,
            normalization_warnings=normalized.warnings,
        )
    elif normalized.canonical_schema == MUSICIR_V2_SCHEMA:
