...
SUPPORTED_SCHEMAS = frozenset({MUSICIR_V1_SCHEMA, MUSICIR_V2_SCHEMA, MUSICIR_V3_SCHEMA})
...
def normalize_musicir_spec(
    ...
    *,
    ...
    if source_schema == MUSICIR_V3_SCHEMA:
        canonical_schema = MUSICIR_V3_SCHEMA
    elif source_schema == MUSICIR_V2_SCHEMA:
